function [net,stats] = cnnTrainDetSeg(net, prefixStr, imdb, getBatch, varargin)
...
%         stats.val(epoch) = degSeg_processEpoch(net, state, opts.scalingFactor, opts, 'val', opts.numEpochs) ;
        [stats.train(epoch),prof] = degSeg_processEpoch(net, state, opts.scalingFactor, opts, 'train', opts.numEpochs) ;
        stats.val(epoch) = degSeg_processEpoch(net, state, opts.scalingFactor, opts, 'val', opts.numEpochs) ;
        ...
        spmd
            ...
            [stats_.train, prof_] = degSeg_processEpoch(net_, state, opts.scalingFactor, opts, 'train') ;
            stats_.val = degSeg_processEpoch(net_, state, opts.scalingFactor, opts, 'val') ;
