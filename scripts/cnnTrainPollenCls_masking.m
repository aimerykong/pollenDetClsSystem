function [net,stats] = cnnTrainPollenCls_masking(net, prefixStr, imdb, getBatch, varargin)
...
%         stats.val(epoch) = pollenCls_processEpoch_masking(net, state, opts.scalingFactor, opts, 'val', opts.numEpochs) ;
        [stats.train(epoch),prof] = pollenCls_processEpoch_masking(net, state, opts.scalingFactor, opts, 'train', opts.numEpochs) ;
        stats.val(epoch) = pollenCls_processEpoch_masking(net, state, opts.scalingFactor, opts, 'val', opts.numEpochs) ;
        ...
        spmd
            ...
            [stats_.train, prof_] = pollenCls_processEpoch_masking(net_, state, opts.scalingFactor, opts, 'train') ;
            stats_.val = pollenCls_processEpoch_masking(net_, state, opts.scalingFactor, opts, 'val') ;
