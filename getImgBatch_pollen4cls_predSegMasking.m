function [imt, mask, imo, label] = getImgBatch_pollen4cls_predSegMasking(images, mode, scaleFactor, varargin)
...
%     gtOrg = 0;
    ...
    gtOrg = single(imread( opts.imdb.predSegMaskList{images} ));                
%     gtOrg(gtOrg~=0) = 2;
%     gtOrg(gtOrg==0) = 1;
