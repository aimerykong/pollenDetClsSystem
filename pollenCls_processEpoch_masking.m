function [stats, prof] = pollenCls_processEpoch_masking(net, state, scalingFactor, opts, mode, totalEpoch)
% -------------------------------------------------------------------------
...
start = tic ;
for t = 1:opts.batchSize:numel(subset) %40363
...
%     end
    ...
    for s=1:opts.numSubBatches
        ...
        [image, mask, imageOrg, label] = state.getBatch(batch, mode, scalingFactor) ;    
