...
netbasemodel.addLayer( lName, ...
    dagnn.Pooling('poolSize', [21 21], 'method', 'avg'), ...
    sName, ...
    lName) ;
sName = lName;
...
opts.expDir = fullfile('./exp', 'main030_cls_res50_gtOnly_avgPool');
