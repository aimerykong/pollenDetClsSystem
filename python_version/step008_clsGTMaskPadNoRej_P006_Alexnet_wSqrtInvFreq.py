...
project_name = 'step008_clsGTMaskPadNoRej_P006_Alexnet_wSqrtInvFreq' 
...
################## init model ###################
#initModel = PollenClsNet(50, nClass=47, pretrained=True, poolSize=16)
initModel = PollenClsNet(0, nClass=47, modelName='alex', pretrained=False, poolSize=16)
