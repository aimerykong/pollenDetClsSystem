...
def flow_error(list_predFlow, list_grndFlow):
    ...
    '''
    u = list_predFlow[:, 0, bord:-bord-1,bord:-bord-1]
    v = list_predFlow[:, 1, bord:-bord-1,bord:-bord-1]
    tu = list_grndFlow[:, 0, bord:-bord-1,bord:-bord-1]
    tv = list_grndFlow[:, 1, bord:-bord-1,bord:-bord-1]    
