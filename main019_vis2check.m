...
% saveFolder = 'main011_segDet_alexnet';
% modelName = 'softmax_net-epoch-32.mat';

% saveFolder = 'main011_segDet_res50';
% modelName = 'softmax_net-epoch-10.mat';

saveFolder = 'main011_segDet_res50_whole';
modelName = 'softmax_net-epoch-4.mat';
%% setup network
...
for imgIdx = 1:30%:length(imdb.val)
    ...
    subplot(subWindowH,subWindowW,windowID); windowID = windowID + 1;
    imagesc(gtOrg); title(sprintf('gtSeg')); axis off image; caxis([1,2]);
    subplot(subWindowH,subWindowW,windowID); windowID = windowID + 1;
